...
<%
    ...
    List<Marca> listam = daom.listar();    
       ...
       listap2=daop.listar();
        ...
        listap2 = daop.filtrar(request.getParameter("filtro"));
    }
        if(request.getParameter("marca")!=null){
            listap2 = daop.listar(Integer.parseInt(request.getParameter("marca")),"M");
        }
           else
       if(request.getParameter("categoria")!=null){
                listap2 = daop.listar(Integer.parseInt(request.getParameter("categoria")),"C"); 
                }else{
                   daop.listar();
                        }
			...
			<div class="header-left">
				...
				<div class="search-box">
					<div id="sb-search" class="sb-search">
						<form>
							<input class="sb-search-input" placeholder="Filtrar..." name="filtro" type="text" >
	...
	<div class="cont">
		<div class="content">
			<div class="content-top-bottom">
                ...
                <%
                            for (Produto pitem2 : listap2) {
                        %>
					<div class="col-md-3 grid-top simpleCart_shelfItem">
						 <a href="single.jsp?codigo=<%=pitem2.getCodigo()%>" class="b-link-stripe b-animate-go  thickbox"><img src="../../Fotos/<%=pitem2.getImagem1()%>" width="65" height="200" />
							<div class="b-wrapper">
								<h3 class="b-animate b-from-left    b-delay03 ">
									<span><%=pitem2.getTitulo()%></span>
					...
					<p><a href="single.jsp?codigo=<%=pitem2.getCodigo()%>" class><%=pitem2.getTitulo()%></a></p>
					<a href="#" class="item_add"><p class="number item_price"><i> </i><%=pitem2.getPreco()%></p></a>
					</div>
