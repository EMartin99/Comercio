...
<%
    ...
    List<Usuario> lista;
     if(request.getParameter("login")!=null){
        Usuario obj = dao.buscarPorChavePrimaria(Integer.parseInt(request.getParameter("login")));
        if(obj!=null){
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="upd.jsp?codigo=<%=item.getLogin()%>" class="btn  btn-primary btn-sm">Alterar</a>
                            <a href="index.jsp?codigo=<%=item.getLogin()%>" class="btn  btn-primary btn-sm">Excluir</a>  
                         </td>
                    </tr>
                    <%
                        }
